...
export const TERMS_LIST = [
  {
    ...
    detail:
      '제1장 총칙\n' +
      '제1조 (목적)\n' +
      '이 약관은 주식회사 고미페이먼츠(이하 “회사”라 합니다)가 모바일 및 PC 기기를 통해 제공하는 서비스 및 이에 부수하는 네트워크, 웹사이트, 기타 서비스(이하 “서비스”라 합니다)의 이용에 대한 회사와 서비스 이용자의 권리ㆍ의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.\n' +
      '\n' +
      '\n' +
      '제2조 (용어의 정의)\n' +
      '① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.\n' +
      '1. “회사”라 함은 모바일 및 PC 기기를 통하여 서비스를 제공하는 사업자를 의미합니다.\n' +
      ...
      '5. “계정정보”란 회원의 회원번호와 외부계정정보, 기기정보, 별명, 프로필 사진, 친구목록 등 회원이 회사에 제공한 정보와 서비스이용정보, 이용요금 결제 정보 등을 통칭합니다.\n' +
      '6. “콘텐츠”란 모바일 기기 및 PC로 이용할 수 있도록 회사가 서비스 제공과 관련하여 디지털 방식으로 제작한 유료 또는 무료의 내용물 일체(서비스 및 네트워크 서비스, 애플리케이션, 서비스 머니. 등)를 의미합니다.\n' +
      '7. “애플리케이션”이란 회사가 제공하는 서비스를 이용하기 위하여 모바일 기기를 통해 다운로드 받거나 설치하여 사용하는 프로그램 일체를 의미합니다.\n' +
      '8. “서비스”라 함은 회사가 제공하는 서비스의 하나로서 회원이 모바일 및 PC 기기에서 실행하는 메인 서비스 및 이에 부수하는 서비스를 의미합니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '⑤ 회사는 「전자상거래 등에서의 소비자보호에 관한 법률」, 「약관의 규제에 관한 법률」, 「서비스산업진흥에 관한 법률」, 「정보통신망이용촉진 및 정보보호 등에 관한 법률」, 「콘텐츠산업진흥법」 등 관련 법령에 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.\n' +
      '\n' +
      '\n' +
      '제5조 (이용계약의 체결 및 적용)\n' +
      ...
      '3. 「서비스산업진흥에 관한 법률」등 관련 법령에서 금지하는 행위를 할 목적으로 신청 하는 경우\n' +
      ...
      '\n' +
      '제6조 (약관 외 준칙)\n' +
      '이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 「전자상거래 등에서의 소비자보호에 관한 법률」,「약관의 규제에 관한 법률」,「서비스 산업진흥에 관한 법률」,「정보통신망이용촉진 및 정보보호 등에 관한 법률」,「콘텐츠산업진흥법」 등 관련 법령 또는 상 관례에 따릅니다.\n' +
      '\n' +
      '\n' +
      '제7조 (운영정책)\n' +
      ...
      '\n' +
      '\n' +
      '③ 회원은 부정한 결제가 이루어지지 아니하도록 결제 비밀번호 기능을 설정하고 관리하여야 합니다. 회원의 부주의로 인하여 발생하는 손해에 대해 회사는 책임지지 않습니다\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '제12조 (서비스의 이용)\n' +
      '① 서비스는 회사의 영업방침에 따라 정해진 시간 동안 제공합니다. 회사는 서비스 제공시간을 애플리케이션 초기화면이나 서비스 공지사항에 적절한 방법으로 안내합니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '② 회사는 영업양도․분할․합병 등에 따른 영업의 폐지, 서비스 제공의 계약만료, 당해 서비스의 현저한 수익 악화 등 경영상의 중대한 사유로 인해 서비스를 지속하기 어려운 경우에는 서비스 전부를 중단할 수 있습니다. 이 경우 중단일자 30일 이전까지 중단일자․중단사유․보상조건 등을 애플리케이션 초기화면 또는 그 연결화면을 통해 공지하고 제27조 제1항의 방법으로 회원에게 통지합니다.\n' +
      '\n' +
      '\n' +
      ...
      '① 회원은 제10조에 따른 회원의 의무를 위반하는 행위를 하여서는 안 되며, 해당 행위를 하는 경우에 회사는 다음 각 호의 구분에 따른 회원의 서비스 이용제한, 관련 정보(글, 사진, 영상 등) 삭제 및 기타의 조치를 포함한 이용제한 조치를 할 수 있습니다. 이용제한 조치가 이루어지는 구체적인 사유 및 절차는 제19조 제1항에 따라 개별 서비스의 운영정책에서 정합니다.\n' +
      ...
      '① 회사는 제17조 제1항에 따른 이용제한 조치의 구체적인 사유 및 절차를 제10조 제1항에 따른 금지행위의 내용․정도․횟수․결과 등을 고려하여 운영정책으로 정합니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '제5장 청약철회와 오납금의 환급 및 이용계약의 해지\n' +
      '제20조 (대금결제)\n' +
      '① 콘텐츠에 대한 구매 대금의 부과와 납부는 원칙적으로 전자상거래법 등에서 정하는 정책이나 방법에 따릅니다. 또한 각 결제수단별 한도가 회사 또는 카드사가 정하는 정책 또는 정부의 방침에 따라 부여되거나 조정될 수 있습니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '⑤ 회원이 청약철회를 할 경우 회사는 구매내역을 확인합니다. 또한 회사는 회원의 정당한 철회 사유를 확인하기 위해 회원에게서 제공받은 정보를 통해 회원에게 연락할 수 있으며, 추가적인 증빙을 요구할 수 있습니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '③ 환급은 서비스를 이용하고 있는 회원 계정에 따라 회사의 환급정책으로 진행됩니다.\n' +
      '\n' +
      '\n' +
      ...
      '\n' +
      '\n' +
      '⑧ 회사는 회원의 데이터, 머니 등의 손실에 대하여 책임을 지지 않습니다. 다만, 회사의 고의 또는 과실에 의한 경우에는 그러하지 아니합니다.\n' +
      '\n' +
      '\n' +
      '⑨ 회사는 회원이 계정, 비밀번호, 결제정보 등을 관리하지 않아 발생하는 손실에 대해 책임을 지지 않습니다. 다만, 회사의 고의 또는 과실에 의한 경우에는 그러하지 아니합니다.\n' +
      '\n' +
      '\n' +
  ...
  },
  {
    ...
    detail:
      '개인(신용)정보 수집 및 이용 동의\n' +
      '주식회사 고미페이먼츠(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.\n' +
      '\n' +
      '\n' +
      '제1조 개인정보의 처리목적\n' +
      ...
      '\n' +
      '1. 콘텐츠 제공\n' +
      '고미인사이트 및 국내 상품의 해외 수출을 돕는 다양한 정보성 콘텐츠 제공 등을 목적으로 개인정보를 처리합니다.\n' +
      '\n' +
      '\n' +
      '2. 마케팅 및 설문조사\n' +
      '서비스 소식 안내 및 보다 안정적이고 고객 맞춤형 솔루션을 제공하기 위해 각종 설문조사 요청 등을 목적으로 개인정보를 처리합니다.\n' +
      '\n' +
      '\n' +
      '3. 민원 처리\n' +
      ...
      '\n' +
      '\n' +
      '② 각각의 개인정보 처리 및 보유 기간 : 회사로 개인정보 삭제 요청 시까지\n' +
      ...
      '\n' +
      '\n' +
      '1. 서비스 이용을 위한 회원 가입 : 이메일 주소(필수), 휴대폰 번호(필수) \n' +
      '\n' +
      '\n' +
      ...
      '이 개인정보 처리방침은 2023.3.10 부터 적용됩니다.\n' +
      '\n' +
      '\n' +
      '\n' +
      '주식회사 고미페이먼츠(이하 ‘회사’라 함)는 회원의 개인정보를 ‘개인정보보호법’ 등 관계 법령에 의거하여 안전하게 관리 및 보호하고 있습니다.\n' +
      '\n' +
      '\n' +
      '회사의 고미인사이트 서비스(이하 ‘서비스’라 함)에서는 개인정보의 수집 및 이용 등 처리에 있어서 아래의 사항을 정보주체에게 안내하고 동의를 받습니다. 정보주체에게는 개인정보의 수집 및 이용을 거부할 권리가 있으나, 아래 개인정보 수집 관련 사항은 서비스 제공을 위한 최소한의 개인정보 수집으로서 본 동의를 거부하실 경우, 서비스 이용이 불가능합니다.\n' +
      '\n' +
      '\n' +
      '1. 수집하는 개인정보 항목\n' +
      '고미인사이트 회원가입 시점에 회사가 이용자로부터 수집 및 이용하는 개인정보는 아래와 같으며, 서비스 제공을 위해 필요한 필수 개인정보만 수집하고 있습니다.\n' +
      '이메일 주소(아이디)\n' +
      '비밀번호\n' +
      '담당자명\n' +
      '담당자 연락처\n' +
      '\n' +
      '\n' +
      '또한 서비스 이용 과정에서 서비스 이용 기록, 접속 로그, 쿠키, IP 주소, 기기 정보 등이 생성되어 저장될 수 있습니다.\n' +
      '\n' +
      '\n' +
      '2. 개인정보의 수집 및 이용목적\n' +
      '가. 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금 정산\n' +
      '콘텐츠 제공, 특정 맞춤 서비스 제공, 물품 배송 또는 청구서 등 발송, 본인인증, 구매 및 요금 결제, 정산, 요금 추심\n' +
      '나. 회원관리 및 부정이용 방지\n' +
      '회원제 서비스 제공, 개인식별, 가입 및 회원 탈퇴 의사의 확인, 만 14세 미만 아동 개인정보 수집 시 법정 대리인 동의 여부 확인, 추후 법정 대리인 본인확인, 불만 처리 등 민원처리, 고지사항 전달\n' +
      '서비스의 가입 및 가입 횟수 제한, 서비스 이용약관 위반 회원에 대한 이용 제한 조치, 서비스의 원활한 운영에 지장을 미치는 행위 및 서비스 부정이용 행위 제재, 분쟁 조정을 위한 기록 보존\n' +
      '다. 신규 서비스 개발 및 마케팅·광고에의 활용\n' +
      '신규 서비스 개발 및 맞춤 서비스 제공, 통계학적 특성에 따른 서비스 제공 및 광고 게재, 서비스의 유효성 확인, 이벤트 정보 및 참여 기회 제공, 광고성 정보 제공, 접속 빈도 파악, 회원의 서비스 이용에 대한 통계\n' +
      '\n' +
      '\n' +
      '3. 개인정보의 보유 및 이용 기간\n' +
      ...
      '\n' +
      '\n' +
      '관련 법령에 의해 일정 기간 보관이 필요한 개인정보의 경우, 해당 법령의 규정에 따라 보관합니다.\n' +
      '<내부 정책에 의한 정보 보유 사유>\n' +
      '보유 정보 : 아이디\n' +
      '보유 이유 : 재가입 신청 방지\n' +
      '보유 기간 : 탈 후 30일간 보관\n' +
  ...
  },
  {
    ...
    detail:
      ...
      '\n' +
      '제공하는 개인(신용)정보 항목\n' +
      '사업자등록번호, 상호명,대표자명, 휴대전화번호,개업연월일, 법인등록번호,주소, 대표자 생년월일]\n' +
      '\n' +
      '개인정보를 제공받는 자의 개인(신용)정보 보유 및 이용기간\n' +
      '개인(신용)정보의 수집 및 이용목적 달성 시까지 \n' +
      '\n' +
      '\n' +
      '2. 개인(신용)정보의 처리 위탁\n' +
      ...
      'SMS/LMS 발송 ㅣ 다우기술 \n' +
      '\n' +
      '전자계약 발송/처리  ㅣ (주)제이씨원, 모두싸인\n' +
      '\n' +
      '채권추심  ㅣ 중앙신용정보주식회사\n' +
      '\n' +
      '고객센터 운영 및 고객 상담, 마케팅 업무  ㅣ 채널코퍼레이션\n' +
      '\n' +
      '메일 발송  ㅣ 스티비 주식회사\n' +
      '\n' +
      '위탁업무를 위해 제공되는 정보는 해당 업무를 위해 필요한 최소한의 정보만 제공되며, 위탁 계약시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련 지시 엄수, 개인정보에 관한 금지 및 사고시의 책임부담 등을 명확히 규정하고 있습니다. 동 업체가 변경될 경우, 회사는 변경된 업체명을 개인(신용)정보처리방침에 공지합니다.\n' +
      '\n' +
      '\n' +
      '3. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익\n' +
      '회원은 회사가 제공하는 서비스에 필요한 개인(신용)정보에 대하여 수집 및 이용에 대한 동의를 거부할 수 있으며, 이 경우 해당 서비스에 대한 이용이 불가능할 수 있습니다.\n',
  },
  {
    ...
    detail:
      ...
      '\n' +
      '목적\n' +
      '고미인사이트 서비스가 제공하는 이용자 맞춤형 서비스 및 상품 추천, 각종 경품 행사, 이벤트 등의 광고성 정보 제공(이메일, 서신우편, SMS, 카카오톡, 푸시알림 등)\n' +
      '항목\n' +
