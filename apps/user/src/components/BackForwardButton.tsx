...
export const BackforwardButton = ({
  ...
  return (
    <button
      className={`${style} absolute z-10 flex h-[52px] w-[52px] cursor-pointer items-center justify-center rounded-[52px] border-[1px] bg-white shadow-[0px_2px_6px_rgba(0,0,0,0.08)]`}
      onClick={() => callback()}
      style={originStyle}
    >
      <ReactSVG
