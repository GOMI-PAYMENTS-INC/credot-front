import abstractPng from './abstract.png';
import bcCardPng from './bc-card.png';
import equalPng from './equal.png';
import hanaCardPng from './hana-card.png';
import hyundaeCardPng from './hyundae-card.png';
...
export const hyundaeCard = hyundaeCardPng;

export const hanaCard = hanaCardPng;

export const lotteCard = lotteCardPng;

export const samsungCard = samsungCardPng;

export const bcCard = bcCardPng;
