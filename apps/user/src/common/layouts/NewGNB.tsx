...
const GNB = () => {
  ...
  return (
    <header className='fixed top-0 z-30 flex w-full justify-between border-[1px] border-grey-300 bg-white px-[60px] py-[14px]'>
      ...
      <div className='flex h-[44px]'>
        ...
        <div className='relative ml-2.5 flex items-center'>
          <div
            className='flex w-[208px] cursor-pointer items-center justify-end py-3 px-5 text-M/Medium text-grey-800'
