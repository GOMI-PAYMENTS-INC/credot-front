...
export const LoginView = ({
  ...
  requestBond(input: RequestCrawlingDto): Promise<CrawlingResponseDto>;
  loading: boolean;
}) => {
  const {
    register,
  ...
  const onValid = async (values: ISearchForm) => {
    const input: RequestCrawlingDto = {
      ...
      type: CrawlingTypeEnum.EASYSHOP_SALES,
    };
          ...
          <div className='mb-[40px] space-y-5'>
            <div className='inputCustom-group'>
              <div className='inputCustom-textbox-wrap'>
                ...
                >
                  <option value={CrawlingTypeEnum.EASYSHOP_SALES}>이지샵(KICC)</option>
                </CustomSelect>
              </div>
            </div>
            <div className='inputCustom-group'>
