  ...
  return (
    <>
      <div
        ...
        } fixed right-[120px] bottom-[151px] w-[256px] w-full cursor-pointer rounded-[100px] bg-gradient-to-b from-grey-800 to-[#323131] py-[14px] px-[32px] text-white shadow-[0px_8px_16px_rgba(0,0,0,0.08)] transition-all`}
      >
