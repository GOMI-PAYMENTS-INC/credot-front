        ...
        <div className='container-tab'>
          <div className='grid-12 mb-[100px] pb-8 lg:mb-[72px] lg:pb-0  sm:mb-10 sm:block sm:pb-0 '>
            <div className='col-span-8 col-start-3 lg:col-span-10 lg:col-start-2 md:col-span-full md:col-start-1'>
              <ul className='grid grid-cols-5 grid-rows-tab grid-rows-1  gap-y-6 gap-x-8 lg:gap-x-4 lg:gap-y-6 sm:flex sm:overflow-x-auto'>
          ...
          <div className='sm:hidden'>
            ...
            >
              {partnerData.map((partener, index) => (
                <SwiperSlide
                  key={index}
                  className='rounded-[16.5097px] border border-grey-300 bg-white p-6 shadow-partnerCard md:p-[18.54px]'
                >
          ...
          <div className='hidden sm:block'>
            <ul>
              {partnerData.map((partener, index) => (
                <li
                  key={index}
                  className='mb-6 rounded-[16.5097px] border border-grey-300 bg-white p-6 shadow-partnerCard md:p-[18.54px]'
                >
                  <div className='mb-6 md:mb-[18.54px]'>
                    <div className='flex'>
                      <div className='mr-2.5 h-[65px] w-[65px] md:mr-[7.73px] md:h-[43.25px] md:w-[43.25px]'>
