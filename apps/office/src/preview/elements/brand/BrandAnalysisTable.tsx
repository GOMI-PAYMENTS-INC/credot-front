...
import { convertExchangeRate, roundNumber, formatNumber } from '@/preview/container';
...
export const BrandAnalysisProductTable = (props: IBrandAnalysisProductTable) => {
  const { brandAnalysisProduct, currencyUnit, basePrice, scrollerRef } = props;

  //FIXME: 모든 계산로직은 데이터를 서버에서 받아온 후, reducer에 가공한 데이터를 넣자
  return (
    <table className='relative z-[2] col-span-full mt-[27px] block max-h-[436px] w-full overflow-hidden rounded-xl border-[1px] bg-white xs:hidden'>
