...
import { SEO_INSIGHT, CONTENT_LIST } from '@/blog/constants';

export const SEO = () => {
  const SERP_BLOG = CONTENT_LIST.find(
    (content) => content.text === 'SERP, 검색 결과 화면 분석의 중요성',
  )!;
  return (
    <div id='content_frame' className='flex flex-col items-center justify-center'>
      <img
        src='/assets/images/SEO.png'
        className='mb-[50px] rounded-lg border-[1px] border-grey-100'
      />
      <section
        id='contents'
        className='max-w-[760px] space-y-[50px] divide-y-[2px] divide-grey-200'
      >
        <section id='content_header' className='space-y-[50px]'>
          ...
          <section className='pt-[50px]' id='content_main'>
            <div
              id='content_summary'
          ...
          <section className='pt-[50px]' id='content_about_search'>
            <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
              ...
              <div className='space-y-[50px]'>
                ...
                <p>
                  ...
                  86%가 ‘키워드 검색’으로부터 발생하고 있으며, 검색 이후 상품의
                  상세페이지로 넘어가는 클릭의 80%는 검색결과 화면 첫 페이지에서 발생
                  한다고 합니다.
                </p>
                <p>
                  이렇듯 우리가 아무리 많은 상품을 업로드하여 판매한다 해도 결국 자신의
                  상품이 <span className='text-L/Bold'>키워드 검색결과 화면</span>(이하
                  키워드 검색결과 화면<span className='text-L/Bold'> SERP</span>라
                  하겠습니다.) 상위에 노출되지 않는다면, 소비자들은 우리 상품의 존재
                  자체를 인식하지 못할 것입니 다. 즉 이커머스 플랫폼에서 판매자에게 상위
                  노출은 그만큼 매우 중요한 요소입니다.
                  <br />
        ...
        <section className='pt-[50px]' id='content_mechanism'>
          <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
            <p className='text-2XL/Bold'>상위 노출 시 선순환 효과</p>
            <div className='space-y-[50px]'>
              <p>
              ...
              <div className='flex flex-col gap-5'>
                ...
                <div className='space-y-[50px] text-L/Regular leading-[44px]'>
                  <p>
                    ...
                    많이 거론되고 있습니다. SEO 작업은
                    <span className='ml-1 text-L/Bold'>
                      검색엔진이 어떤 알고리즘으로 데이터를 불러와 화면상에 순위를 정하여
                      나타내느지를 분석하는 작업
                    </span>
                    이라 고도 할 수 있습니다.
                  </p>
                  <p>
                    ...
                    불가능하지만, 상위 노출이 되고 있는
                    <span className='ml-1 text-L/Bold'>
                      상품들의 특징 또는 상관 관계를 분석하여 알고리즘을 유추해보고 이를
                      내 상품등록 혹은 운영 과정에 적용함으로서 SEO 작업을 진행
                    </span>
                    할 수 있습니다.
                  </p>
                  <p>
        ...
        <section className='pt-[50px]' id='content_mechanism'>
          <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
            <p>
              ...
              디테일한 항목별로 분석하여 판매자분께 SEO를 위한 다양한 인사이트를 제공하고
              있습니다.
            </p>
        ...
        <section id='recommand_contents'>
          <div className='mt-[50px] flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-[50px]'>
              <Card content={SERP_BLOG} type='recommandation' />
            </div>
          </div>
        </section>
      </section>
