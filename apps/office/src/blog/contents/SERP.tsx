  ...
  return (
    <div id='content_frame' className='flex flex-col items-center justify-center'>
      ...
      >
        ...
        <section className='pt-[50px]' id='content_mechanism'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='text-L/Regular leading-[44px]'>
              ...
              우리는 이 화면을
              <span className='text-L/Bold'> ‘검색결과 화면’</span> 또는
              <span className='text-L/Bold'> ‘SERP(Search Engine Result page)’</span>라
              부릅니다.
            </p>
            ...
            <p className='text-L/Regular leading-[44px]'>
              ...
              검색엔진들이 가장 기본적으로 체크하는 항목은 바로
              <span className='mx-1 text-L/Bold'>
                “상품 제목에 소비자가 입력한 키워드가 있는가?”
              </span>
              일 것입니다. 그 외에도 중요도는 다르겠지만 만족도, 제목, 리뷰, 이미지, 영상,
              문의 등 매우 다양한 요소들이 평가될 것입니다.
            </p>
        ...
        <section className='pt-[50px]' id='content_important_of_analysis_serp'>
          <div className='flex flex-col gap-5'>
            ...
            <div className='space-y-[50px] text-L/Regular leading-[44px]'>
              <p>
                ...
                우리는 Shopee의 검색엔진 알고리즘이 어떤 개발 코드들로 짜여져 있는지
                정확하게 알 방법이 없습니다.
              </p>
              ...
              <p>
                ...
                작업들을 <span className='text-L/Bold'> 검색 엔진 최적화</span>또는
                <span className='text-L/Bold'> SEO</span>라고 부릅니다.
              </p>
            </div>
          </div>
        </section>

        <section className='pt-[50px]' id='content_seo'>
          <div className='flex flex-col gap-5'>
        ...
        <section className='pt-[50px]' id='content_explain_gomi_report'>
          <div className='flex flex-col gap-5'>
        ...
        <section id='recommand_contents'>
          <div className='mt-[50px] flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-[50px]'>
              <Card content={SEO_BLOG} type='recommandation' />
            </div>
          </div>
        </section>
      </section>
