...
export const SearchTrend = () => {
  const [_, CVR, CPC] = CONTENT_LIST.filter((content) => content.category === 'product');
  return (
    <div id='content_frame' className='flex flex-col items-center justify-center'>
      ...
      >
          ...
          <section id='content_intro'>
            <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
              <div className='space-y-[50px]'>
                ...
                <p>
                  이번 포스팅에서는 시장의 트랜드를 나타내는 ‘검색량 추이’의 다양한
                  케이스를 살펴보고 리포트를 함께 해석 해보는 시간을 갖도록 하겠습니다.
                </p>
              </div>
            </div>
          </section>
        ...
        <section className='pt-[50px]' id='content_pattern_of_trend'>
          <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
            ...
            <div className='space-y-[50px]'>
              <div className='flex flex-col gap-5'>
                ...
                <img className='mb-[30px]' src='/assets/images/searchTrend/CASE1.png' />
                <div className='space-y-[50px] text-L/Regular leading-[44px]'>
                  <p>
                    위 차트는 싱가포르에서 <span className='text-L/Bold'>airpods </span>
                    키워드의 최근 3년간의 검색량 추이입니다. 차트를 통해 키워드에 대한
                    수요 가 주로 하반기에 강세를 보인다는 것을 알 수 있습니다. 검색량
                    추이가 위와 같은 패턴을 보이는 상품을 판매 한다면, 상반기에 미리
                    재고를 준비하고 하반기에 판매에 집중하는 것이 재고 및 현금 운영에
                    효율적일 수 있습 니다.
                  </p>
                  <p>
              ...
              <div className='flex flex-col gap-5'>
                ...
                <img className='mb-[30px]' src='/assets/images/searchTrend/CASE2.png' />
                <div className='space-y-[50px] text-L/Regular leading-[44px]'>
                  <p>
                    위 차트는 말레이시아에서 <span className='text-L/Bold'>yuzu </span>
                    키워드의 최근 3년간의 검색량 추이입니다. 어떠한 이유인지 최근 3년간 키
                    워드의 수요가 점진적으로 증가 추세임을 확인할 수 있습니다. 이 차트는
                    고미인사이트에서 가장 이상적으로 생각하는 검색량 추이 차트입니다.
                  </p>
                  <p>
                    ...
                    등 고미인사이트에서 제공하는 리포트의 다양한 분석자료를 종합적으로
                    분석 후 해당 키워드 시장에 진입하는 것이 유리합니다.
                  </p>
                  <img
                    className='mt-[30px]'
                    src='/assets/images/searchTrend/CASE2-1.png'
                  />
                </div>
              </div>
              ...
              <div className='flex flex-col gap-5'>
                ...
                <img className='mb-[30px]' src='/assets/images/searchTrend/CASE3.png' />
                <div className='space-y-[50px] text-L/Regular leading-[44px]'>
                  <p>
                    위 차트는 싱가포르에서 <span className='text-L/Bold'> mussels </span>
                    키워드의 최근 3년간의 검색량 추이입니다. 앞서 예시를 들었던 키워드와는
                    반대로 최근 3년간 키워드의 수요가 점진적으로 감소 추세임을 확인할 수
                    있습니다. 키워드의 수요가 특별한 외부 요인으로 인해 다시 증가할
                    가능성도 있겠지만, 데이터만을 보고 평가했을 시 매출이 점점 감소할
                    가능성 이 큰 키워드의 패턴입니다.
                  </p>
                </div>
              </div>
              ...
              <div className='flex flex-col gap-5'>
                ...
                <img className='mb-[30px]' src='/assets/images/searchTrend/CASE4.png' />
                <div className='space-y-[50px] text-L/Regular leading-[44px]'>
                  <p>
                    위 차트는 말레이시아에서 <span className='text-L/Bold'> lion</span>
                    키워드의 최근 3년간의 검색량 추이입니다. 특별한 변동성 없이 매년
                    꾸준한 수요가 유지되고 있습니다. 이러한 패턴을 보이는 키워드를 통해
                    매출이 발생할 경우, 앞으로의 매출과 판매량 에 대한 예측이 쉬우며
                    재고관리가 용이하다는 장점이 있습니다. 이 또한 고미인사이트에서
                    선호하는 검색량 추이입니다.
                  </p>
                </div>
              </div>
        ...
        <section className='pt-[50px]' id='content_strategies'>
          <div className='flex flex-col gap-5 text-L/Regular leading-[44px]'>
