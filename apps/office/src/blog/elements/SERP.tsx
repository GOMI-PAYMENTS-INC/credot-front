...
const SERP = () => {
  return (
    <div id='content_frame' className='flex flex-col items-center justify-center'>
      ...
      <section id='contents' className='max-w-[760px] space-y-[70px]'>
        ...
        <section id='content_main'>
          ...
          >
            ...
            <ul className='ml-4 flex max-w-[690px] list-outside list-disc flex-col gap-5 text-L/Light leading-8'>
              <li>
                이커머스 플랫폼 매출의 86%가 ‘키워드 검색’으로부터 시작되는만큼, 검색결과
                화면에 내 상품을 노출시키는 것이 중요해요.
              </li>
              <li>
        ...
        <section id='content_about_search'>
          <img src='/assets/images/SearchBars.png' className='pb-20' />
          <div className='flex flex-col gap-5'>
            <p className='text-2XL/Bold'>검색이란</p>
            <p className='text-L/Light leading-[44px]'>
        ...
        <section id='content_mechanism'>
          <div className='flex flex-col gap-5'>
            ...
            <img src='/assets/images/SearchEngine.png' className='my-5' />
            <p className='text-L/Light leading-[44px]'>
            ...
            <p className='mt-5 text-XL/Bold'>검색엔진의 상품 노출순위 평가 항목 예시</p>
            <div className='border-l-[8px] border-grey-300'>
              <ul className='ml-5 flex flex-col gap-5 py-3 text-L/Light'>
        ...
        <section id='content_important_of_analysis_serp'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='text-L/Light leading-[44px]'>
              ...
              될까요? 광고비 없이도 업로드하는 상품마다 키워드 검색결과 화면 1위에 노출될
              것이고 이는 곧 엄청난 매출로 이어지게 될 것 입니다. 하지만 아쉽게도
              우리는Shopee의 검색엔진 알고리즘이 어떤 개발 코드들로 짜여져 있는지 정확하게
              알 방법이 없습니다.
            </p>

            <img src='/assets/images/SearchImportant.png' className='my-5' />
            <p className='text-L/Light leading-[44px]'>
              따라서 우리는 키워드 검색결과 화면에서 어떤 상품들이 상위에 노출되고 있고,
              이 상품들간의 상관 관계나 통계 분석을 통해 역으로 검색 알고리즘이 상품
              순위를 결정하는 로직을 유추하고 적용함으로서, 내 상품이 최대한 상위에
              노출되도록 상품을 등록하고 운영을 해야하는 것입니다. 우리는 이러한 작업들을
              검색 엔진 최적화 또는 SEO라고 부릅니다.
            </p>
          </div>
        </section>
        ...
        <section id='content_seo'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='text-L/Light leading-[44px]'>
              ...
              영역을 제외하고 최대 50개의 상품들이 첫 페이지에 노출될 것입니다. 우리는 이
              50개의 상품들이 어떠한 이유로 Shopee의 검색 알고리즘의 선택을 받게
              되었는지를 분석하기 위해 각 상품들의 상세 페이지에 접속하여 다양한 항목들에
              대한 데이터들을 취합해야 할 것입니다.
            </p>

            <div className='my-5'>
              <p className='pb-5 text-XL/Bold'>조사해볼만한 항목들</p>
              <div className='border-l-[8px] border-grey-300'>
                <ul className='ml-5 flex h-[240px] flex-col flex-wrap gap-5 py-3 text-L/Light'>
            ...
            <p className='text-L/Light leading-[44px]'>
              ...
              항목들이 노출 순위를 정하는 평가 요소들이 아닐 수도 있으며 각 항목들이 노출
              순위에 영향을 주는 정도도 각기 다를 것입니다.
            </p>
            <p className='text-L/Light leading-[44px]'>
        ...
        <section id='content_explain_gomi_report'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='text-L/Light leading-[44px]'>
              ...
              길이로 어떻게 촬영되었는지 등 다양하고 세분화된 항목별 분석 자료들을 한 눈에
              확인할 수 있습니다.
            </p>
