...
const LoginModalComponent = ({ isModalVisible, hide }: ModalComponentProps) =>
  isModalVisible ? (
    <ModalComponent hide={hide} title='로그인' onCancel={() => {}}>
      <form action=''>
      ...
      <div className='pt-5 text-center text-gray-400'>
        <span className='text-s-regular'>
          아직 회원이 아니세요?
          <a href='#' className='ml-2 text-s-bold text-primary-red-orange'>
            회원가입
          </a>
        </span>
      </div>
